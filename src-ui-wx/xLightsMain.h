...
public:
    ...
    void OnMenuAIShowDiagnosticsSelected(wxCommandEvent& event);
    void OnMenuAISequenceRemapperSelected(wxCommandEvent& event);
    void OnMenuAILyricVisemeAlignerSelected(wxCommandEvent& event);
    void OnMenuAIPhotorealisticRendererSelected(wxCommandEvent& event);
    void OnMenuAIPhoto3DReconstructorSelected(wxCommandEvent& event);
    void OnMenuAIThermalThrottlerSelected(wxCommandEvent& event);
    void OnMenuAIAudienceSightlineOptimizerSelected(wxCommandEvent& event);
    void OnMenuAIEngineSettingsSelected(wxCommandEvent& event);
    void OnMenuAIShowNarrativeComposerSelected(wxCommandEvent& event);
    void OnMenuAIPixelAutoHealingSelected(wxCommandEvent& event);
    void OnMenuAINeuralShaderSynthesizerSelected(wxCommandEvent& event);
...
public:
    ...
    static const wxWindowID ID_MENUITEM_AI_SHOW_DIAGNOSTICS;
    static const wxWindowID ID_MENUITEM_AI_SEQUENCE_REMAPPER;
    static const wxWindowID ID_MENUITEM_AI_LYRIC_VISEME_ALIGNER;
    static const wxWindowID ID_MENUITEM_AI_PHOTOREALISTIC_RENDERER;
    static const wxWindowID ID_MENUITEM_AI_PHOTO_3D_RECONSTRUCTOR;
    static const wxWindowID ID_MENUITEM_AI_THERMAL_THROTTLER;
    static const wxWindowID ID_MENUITEM_AI_AUDIENCE_SIGHTLINE_OPTIMIZER;
    static const wxWindowID ID_MENUITEM_AI_ENGINE_SETTINGS;
    static const wxWindowID ID_MENUITEM_AI_SHOW_NARRATIVE_COMPOSER;
    static const wxWindowID ID_MENUITEM_AI_PIXEL_AUTO_HEALING;
    static const wxWindowID ID_MENUITEM_AI_NEURAL_SHADER_SYNTHESIZER;
