...
const long Waveform::ID_WAVE_MNU_AI_AUDIO_STUDIO = wxNewId();
...
const long Waveform::ID_WAVE_MNU_AI_SHOW_NARRATIVE = wxNewId();
...
void Waveform::rightClick(wxMouseEvent& event)
{
    ...
    }
    {
        ...
        aiMenu->Append(ID_WAVE_MNU_AI_AUDIO_STUDIO, "🎵 Open Audio & Singing Face Studio...");
        ...
        aiMenu->Append(ID_WAVE_MNU_AI_SHOW_NARRATIVE, "📜 AI Show Narrative & Voiceover Composer...");
...
void Waveform::OnGridPopup(wxCommandEvent& event)
{
    ...
    int id = event.GetId();
    if (id == ID_WAVE_MNU_AI_AUDIO_STUDIO) {
        wxCommandEvent cmd(wxEVT_COMMAND_MENU_SELECTED, xLightsFrame::ID_MENUITEM_AI_AUDIO_STUDIO);
        wxPostEvent(xLightsFrame::GetFrame(), cmd);
        return;
    } else if (id == ID_WAVE_MNU_AI_AUDIO_STEMS) {
        ...
        wxPostEvent(xLightsFrame::GetFrame(), cmd);
        return;
    } else if (id == ID_WAVE_MNU_AI_SHOW_NARRATIVE) {
        wxCommandEvent cmd(wxEVT_COMMAND_MENU_SELECTED, xLightsFrame::ID_MENUITEM_AI_SHOW_NARRATIVE_COMPOSER);
        wxPostEvent(xLightsFrame::GetFrame(), cmd);
        return;
